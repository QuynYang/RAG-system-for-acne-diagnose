...
user_profile{age,skin_type,is_pregnant,allergies,current_products},
store_catalog[] on the way in; session_id, answer, recommendations, red_flags, safety_flags,
...
class SkinChatRequest(BaseModel):
    ...
    store_catalog: list[str] = Field(default_factory=list)
